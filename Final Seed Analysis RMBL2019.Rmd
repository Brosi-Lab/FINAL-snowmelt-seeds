...
Here's a plot of the Julian days that the snowmelt-accelerated plots melted out, with sites sorted by snowmelt day in the control plots:
...
```
No difference in community similarity of pollinators at the site level driven by snowmelt manipulation.
