...
# # keep the code below commented out for faster knitting:
...
```{r models community fecundity, cache = T}
...
# # (keep this commented out to prevent repeated saving on GitHub)
# # re-save when this changes, but only as needed
# ggsave(plot = pollimplot, width = 6, height = 4,
#        filename = "plots/aggregated-pollen-limitation-plot.pdf")

# cleanup
# rm(pollimplot, pollimsum) 
...
# cleanup
rm(sumxpoll, polllimplotci, polllimplot)
