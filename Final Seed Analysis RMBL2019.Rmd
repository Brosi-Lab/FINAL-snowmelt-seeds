...
challenging because it is an interaction... plan:

* data are *close* to perfect for this---ideally the hand-pollination line would be perfectly flat (it's about as close as it could be realistically)
* really the effect size is the difference between the open pollination treatments
* calculate the mean whole-plant fecundity difference (with all data) for just the three species included in this graph as a baseline to assess the proportional difference driven by pollen limitation

```{r pollen limitation effect overall size}
