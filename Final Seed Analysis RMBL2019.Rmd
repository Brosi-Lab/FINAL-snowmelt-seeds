...
The effect size of the reduction in fecundity is a `R fecund.effect.size`% reduction in overall seed production in the accelerated plots relative to control. 
